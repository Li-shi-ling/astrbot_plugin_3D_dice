...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [422],
  {
      ...
      let o = a.forwardRef(function (
            ...
            () =>
              (function (e, t, r) {
                let n = new i.Shape(),
                  a = r - 1e-5;
                return (
                  n.absarc(1e-5, 1e-5, 1e-5, -Math.PI / 2, -Math.PI, !0),
                  n.absarc(1e-5, t - 2 * a, 1e-5, Math.PI, Math.PI / 2, !0),
                  n.absarc(e - 2 * a, t - 2 * a, 1e-5, Math.PI / 2, 0, !0),
                  n.absarc(e - 2 * a, 1e-5, 1e-5, 0, -Math.PI / 2, !0),
                  n
                );
              })(e, t, o),
            [e, t, o],
        ...
        return (
          a.useLayoutEffect(() => {
            p.current &&
              (p.current.center(),
              (function (e, t = Math.PI / 3) {
                let r = Math.cos(t),
                  n = (1 + 1e-10) * 100,
                  a = [new i.Vector3(), new i.Vector3(), new i.Vector3()],
                  o = new i.Vector3(),
                  l = new i.Vector3(),
                  f = new i.Vector3(),
                  u = new i.Vector3();
                ...
                let c = e.index ? e.toNonIndexed() : e,
                  v = c.attributes.position,
                  d = {};
                for (let e = 0, t = v.count / 3; e < t; e++) {
                  let t = 3 * e,
                    r = a[0].fromBufferAttribute(v, t + 0),
                    n = a[1].fromBufferAttribute(v, t + 1),
                    f = a[2].fromBufferAttribute(v, t + 2);
                  (o.subVectors(f, n), l.subVectors(r, n));
                  let u = new i.Vector3().crossVectors(o, l).normalize();
                  for (let e = 0; e < 3; e++) {
                    let t = s(a[e]);
                    (t in d || (d[t] = []), d[t].push(u));
                  }
                }
                let h = new Float32Array(3 * v.count),
                  g = new i.BufferAttribute(h, 3, !1);
                for (let e = 0, t = v.count / 3; e < t; e++) {
                  let t = 3 * e,
                    n = a[0].fromBufferAttribute(v, t + 0),
                    i = a[1].fromBufferAttribute(v, t + 1),
                    c = a[2].fromBufferAttribute(v, t + 2);
                  (o.subVectors(c, i),
                    l.subVectors(n, i),
                    f.crossVectors(o, l).normalize());
                  for (let e = 0; e < 3; e++) {
                    let n = d[s(a[e])];
                    u.set(0, 0, 0);
                    ...
                    (u.normalize(), g.setXYZ(t + e, u.x, u.y, u.z));
                  }
                }
                c.setAttribute("normal", g);
              })(p.current, s));
          }, [h, g]),
          a.createElement(
            "mesh",
            (0, n.Z)({ ref: d }, v),
            a.createElement("extrudeGeometry", { ref: p, args: [h, g] }),
            c,
          )
        );
      });
    ...
    4379: function (e, t, r) {
      ...
      let f = a.forwardRef(
        (
          ...
          let g = (0, o.D)(({ invalidate: e }) => e),
            [p] = a.useState(() => new i.xv()),
            [m, b] = a.useMemo(() => {
              let e = [],
                t = "";
              return (
          ...
          return (
            (0, l.Rq)(
              () =>
                new Promise((e) => (0, i.C5)({ font: f, characters: c }, e)),
              ["troika-text", f, c],
            ),
            a.useLayoutEffect(
              () =>
    ...
    7390: function (e, t, r) {
      ...
      let n = (0, r(8030).Z)("MessageSquare", [
        [
          "path",
          {
          ...
          return function e(t, r) {
            let a = (function (e) {
                let t = JSON.stringify(e, d),
                  r = g.get(t);
                return (null == r && g.set(t, (r = ++h)), r);
              })(r),
              p = u.get(t);
            if ((p || u.set(t, (p = Object.create(null))), p[a]))
              return new p[a]();
...
`),
                      ...
                      {
                        vertexShader: (t = v(t, a, o, l, f)),
                        fragmentShader: (r = v(r, a, s, c, d)),
                      }
                    );
                  })(this, e, r, a);
                  u = s[o] = t;
              ...
              y = function () {
                return _(r.chained ? t : t.clone());
              },
              _ = function (e) {
                let n = Object.create(e, w);
                return (
                  Object.defineProperty(n, "baseMaterial", { value: t }),
                  Object.defineProperty(n, "id", { value: c++ }),
                  (n.uuid = (function () {
              ...
              w = {
                ...
                clone: {
                  ...
                  configurable: !0,
                  value: function () {
                    return _(new t.constructor()).copy(this);
                  },
                },
                getDepthMaterial: {
                  writable: !0,
                ...
                if ((void 0 === u && (u = null), !e[i]))
                  try {
                    ...
                    ("function" == typeof f
                      ...
                      (e[i] = { id: i, value: s, getTransferables: u }),
                      a(s));
                  } catch (e) {
      ...
      (r.d(t, {
        ...
        Ch: function () {
          return function e(t) {
            ...
            null == s && (s = "#default");
            var c = "workerModule" + ++i,
              h = t.name || c,
              g = null;
            function p() {
              for (var e = [], t = arguments.length; t--; ) e[t] = arguments[t];
              if (!g) {
                g = d(s, "registerModule", p.workerModuleData);
                var r = function () {
                  ((g = null), u[s].delete(r));
                };
                (u[s] || (u[s] = new Set())).add(r);
              }
              return g.then(function (t) {
                if (t.isCallable) return d(s, "callModule", { id: c, args: e });
                throw Error(
                  "Worker module function was called but `init` did not return a callable function",
                );
              });
                ...
                n.map(function (t) {
                  return (
                    "function" != typeof t ||
                      ...
                      (t = e({
                        workerId: s,
                        name: "<" + h + "> function dependency: " + t.name,
      ...
      t.Z = function () {
        return (function (e) {
          ...
          ((o.L = 1),
            ...
            Object.freeze(o));
          var f = o.LRI | o.RLI | o.FSI,
            u = o.L | o.R | o.AL,
            s = o.B | o.S | o.WS | o.ON | o.FSI | o.LRI | o.RLI | o.PDI,
            c = o.BN | o.RLE | o.LRE | o.RLO | o.LRO | o.PDF,
            v = o.S | o.WS | o.B | f | o.PDI | c,
            d = null;
          function h(e) {
            return (
              !(function () {
              ...
              e.split(",").forEach(function e(o) {
                if (-1 !== o.indexOf("+")) for (var l = +o; l--; ) e(r);
                  ...
                  ((u = String.fromCodePoint((n += parseInt(u, 36)))),
                    (s = String.fromCodePoint((n += parseInt(s, 36)))),
                    a.set(u, s),
                    t && i.set(s, u));
                }
              }),
          ...
          function V(e, t, r, n) {
            ...
            return (
              t.paragraphs.forEach(function (a) {
                ...
                if (o < l) {
                  for (
                    var f = t.levels.slice(o, l + 1), u = l;
                    u >= o && h(e[u]) & v;
                    u--
                  )
                    f[u] = a.level;
                  for (var s = a.level, c = 1 / 0, d = 0; d < f.length; d++) {
                    var g = f[d];
                    (g > s && (s = g), g < c && (c = 1 | g));
                  }
                  for (var p = s; p >= c; p--)
                    for (var m = 0; m < f.length; m++)
                      if (f[m] >= p) {
                        for (var b = m; m + 1 < f.length && f[m + 1] >= p; )
                          m++;
                        m > b && i.push([b + o, m + o]);
                      }
                }
          ...
          function z(e, t, r, n) {
            for (var a = V(e, t, r, n), i = [], o = 0; o < e.length; o++)
              i[o] = o;
            return (
          ...
          return (
            ...
            (e.getEmbeddingLevels = function (e, t) {
              ...
              function i(e, t) {
                ...
                ((r[e] = t),
                  a.set(n, a.get(n) - 1),
                  n & s && a.set(s, a.get(s) - 1),
                  a.set(t, (a.get(t) || 0) + 1),
                  t & s && a.set(s, (a.get(s) || 0) + 1));
              }
              for (
                ...
                (g ||
                  d.push(
                    (g = {
                      ...
                      level: "rtl" === t ? 1 : "ltr" === t ? 0 : tS(p, !1),
                    }),
                  ),
                  r[p] & T && ((g.end = p), (g = null)));
              for (
                var m = P | j | C | B | f | q | F | T,
                  W = function (e) {
                    return e + (1 & e ? 1 : 2);
                  },
                  V = function (e) {
                ...
                var $ = [
                    { _level: (g = d[z]).level, _override: 0, _isolate: 0 },
                  ],
                  X = void 0,
                  Z = 0,
                  Y = 0,
                ...
                for (var K = g.start; K <= g.end; K++) {
                  ...
                  if (
                    ((X = $[$.length - 1]),
                    a.set(Q, (a.get(Q) || 0) + 1),
                    Q & s && a.set(s, (a.get(s) || 0) + 1),
                    Q & m)
                  ) {
                    if (Q & (P | j)) {
                      o[K] = X._level;
                      var J = (Q === P ? V : W)(X._level);
                      !(J <= 125) || Z || Y
                        ? !Z && Y++
                        : $.push({ _level: J, _override: 0, _isolate: 0 });
                    } else if (Q & (C | B)) {
                      o[K] = X._level;
                      var ee = (Q === C ? V : W)(X._level);
                      !(ee <= 125) || Z || Y
                        ? !Z && Y++
                        : $.push({
                            _level: ee,
                      ...
                      (Q & G && (Q = 1 === tS(K + 1, !0) ? O : N),
                        (o[K] = X._level),
                        X._override && i(K, X._override));
                      var et = (Q === O ? V : W)(X._level);
                      et <= 125 && 0 === Z && 0 === Y
                        ? (H++,
                          $.push({
                            _level: et,
                    ...
                    ((o[K] = X._level),
                      X._override && Q !== L && i(K, X._override));
                }
                for (var en = [], ea = null, ei = g.start; ei <= g.end; ei++) {
                  ...
                  if (!(eo & c)) {
                    var el = o[ei],
                      ...
                      eu = eo === q;
                    ea && el === ea._level
                      ? ((ea._end = ei), (ea._endsWithIsolInit = ef))
                      : en.push(
                          (ea = {
                            _start: ei,
                            _end: ei,
                            _level: el,
                            _startsWithPDI: eu,
                            _endsWithIsolInit: ef,
                          }),
                        );
                  }
                }
                for (var es = [], ec = 0; ec < en.length; ec++) {
                  var ev = en[ec];
                  if (
                    !ev._startsWithPDI ||
                    (ev._startsWithPDI && !l.has(ev._start))
                  ) {
                    for (
                      var ed = [(ea = ev)], eh = void 0;
                      ea &&
                      ea._endsWithIsolInit &&
                      null != (eh = l.get(ea._end));
                    )
                      for (var eg = ec + 1; eg < en.length; eg++)
                        if (en[eg]._start === eh) {
                          ed.push((ea = en[eg]));
                          break;
                        }
                    for (var ep = [], em = 0; em < ed.length; em++)
                      for (var eb = ed[em], ey = eb._start; ey <= eb._end; ey++)
                        ep.push(ey);
                    for (
                      var e_ = o[ep[0]], ew = g.level, ek = ep[0] - 1;
                      ek >= 0;
                      ek--
                    )
                      if (!(r[ek] & c)) {
                    ...
                    var ex = ep[ep.length - 1],
                      eE = o[ex],
                      eM = g.level;
                    if (!(r[ex] & f)) {
                      for (var eA = ex + 1; eA <= g.end; eA++)
                        if (!(r[eA] & c)) {
                          eM = o[eA];
                          break;
                        }
                    ...
                    es.push({
                      _seqIndices: ep,
                      _sosType: Math.max(ew, e_) % 2 ? k : w,
                      _eosType: Math.max(eM, eE) % 2 ? k : w,
                    });
                  }
                }
                for (var eR = 0; eR < es.length; eR++) {
                  var eT = es[eR],
                    ...
                    eD = 1 & o[eI[0]] ? k : w;
                  if (a.get(D))
                    for (var eU = 0; eU < eI.length; eU++) {
                      var eB = eI[eU];
                      if (r[eB] & D) {
                        for (var eC = eS, ej = eU - 1; ej >= 0; ej--)
                          if (!(r[eI[ej]] & c)) {
                            eC = r[eI[ej]];
                            break;
                          }
                  ...
                  if (a.get(x))
                    for (var eP = 0; eP < eI.length; eP++) {
                      var eF = eI[eP];
                      if (r[eF] & x)
                        for (var eN = eP - 1; eN >= -1; eN--) {
                          var eO = -1 === eN ? eS : r[eI[eN]];
                          if (eO & u) {
                            eO === U && i(eF, A);
                            break;
                          }
                  ...
                  if (a.get(E) || a.get(R))
                    for (var eW = 1; eW < eI.length - 1; eW++) {
                      var eV = eI[eW];
                      if (r[eV] & (E | R)) {
                        for (
                          var ez = 0, e$ = 0, eX = eW - 1;
                          eX >= 0 && (ez = r[eI[eX]]) & c;
                          eX--
                        );
                        for (
                          var eZ = eW + 1;
                          eZ < eI.length && (e$ = r[eI[eZ]]) & c;
                          eZ++
                        );
                        ez === e$ &&
                          (r[eV] === E ? ez === x : ez & (x | A)) &&
                  ...
                  if (a.get(x)) {
                    for (var eY = 0; eY < eI.length; eY++)
                      if (r[eI[eY]] & x) {
                        ...
                        for (
                          eY++;
                          eY < eI.length && r[eI[eY]] & (M | c | x);
                          eY++
                        )
                          r[eI[eY]] !== x && i(eI[eY], x);
                      }
                  }
                  if (a.get(M) || a.get(E) || a.get(R))
                    for (var eK = 0; eK < eI.length; eK++) {
                      var eQ = eI[eK];
                      if (r[eQ] & (M | E | R)) {
                        i(eQ, S);
                        for (var eJ = eK - 1; eJ >= 0 && r[eI[eJ]] & c; eJ--)
                          i(eI[eJ], S);
                        for (
                          var e1 = eK + 1;
                          e1 < eI.length && r[eI[e1]] & c;
                          e1++
                        )
                          i(eI[e1], S);
                      }
                  ...
                  if (a.get(x))
                    for (var e2 = 0, e0 = eS; e2 < eI.length; e2++) {
                      var e3 = eI[e2],
                        e5 = r[e3];
                      e5 & x ? e0 === w && i(e3, w) : e5 & u && (e0 = e5);
                    }
                  if (a.get(s)) {
                    for (
                      var e4 = k | x | A, e6 = e4 | w, e7 = [], e9 = [], e8 = 0;
                      e8 < eI.length;
                      e8++
                    )
                      if (r[eI[e8]] & s) {
                    ...
                    for (var ta = 0; ta < e7.length; ta++) {
                      ...
                      if (tu) {
                        if (((r[eI[to]] = r[eI[tl]] = tu), tu !== eD)) {
                          for (var tp = to + 1; tp < eI.length; tp++)
                            if (!(r[eI[tp]] & c)) {
                              h(e[eI[tp]]) & D && (r[eI[tp]] = tu);
                              break;
                            }
                        }
                        if (tu !== eD) {
                          for (var tm = tl + 1; tm < eI.length; tm++)
                            if (!(r[eI[tm]] & c)) {
                              h(e[eI[tm]]) & D && (r[eI[tm]] = tu);
                              break;
                            }
                        }
                      }
                    }
                    for (var tb = 0; tb < eI.length; tb++)
                      if (r[eI[tb]] & s) {
                        for (
                          var ty = tb, t_ = tb, tw = eS, tk = tb - 1;
                          tk >= 0;
                          tk--
                        )
                          if (r[eI[tk]] & c) ty = tk;
                        ...
                        for (var tx = eL, tE = tb + 1; tE < eI.length; tE++)
                          if (r[eI[tE]] & (s | c)) t_ = tE;
                          else {
                            tx = r[eI[tE]] & e4 ? k : w;
                            break;
                          }
                        for (var tM = ty; tM <= t_; tM++)
                          r[eI[tM]] = tw === tx ? tw : eD;
                        tb = t_;
                      }
                  }
                }
                for (var tA = g.start; tA <= g.end; tA++) {
                  var tR = o[tA],
                    tT = r[tA];
                  if (
                    (1 & tR
                      ...
                      : tT & k
                        ? o[tA]++
                        : tT & (A | x) && (o[tA] += 2),
                    tT & c && (o[tA] = 0 === tA ? g.level : o[tA - 1]),
                    tA === g.end || h(e[tA]) & (I | T))
                  )
                    for (var tI = tA; tI >= 0 && h(e[tI]) & v; tI--)
                      o[tI] = g.level;
                }
              }
            ...
            (e.getReorderSegments = V),
            (e.getReorderedIndices = z),
            (e.getReorderedString = function (e, t, r, n) {
              var a = z(e, t, r, n),
                i = [].concat(e);
              return (
                a.forEach(function (r, n) {
                  i[n] = (1 & t.levels[r] ? W(e[r]) : null) || e[r];
                }),
                i.join("")
              );
            }),
      ...
      function n() {
        return (function (e) {
            ...
            for (
              ...
              switch (r[1]) {
                ...
                case "L":
                  ...
                  break;
                case "Q":
                  t("Q", i, o, (i = f[2]), (o = f[3]), f[0], f[1]);
                  break;
                case "C":
                  t("C", i, o, (i = f[4]), (o = f[5]), f[0], f[1], f[2], f[3]);
                  break;
                case "Z":
                  (i !== n || o !== a) && t("L", i, o, n, a);
              }
          ...
          function r(e, r, n) {
            void 0 === n && (n = 16);
            var a = { x: 0, y: 0 };
            t(e, function (e, t, i, o, l, f, u, s, c) {
              switch (e) {
                case "L":
                  r(t, i, o, l);
                  break;
                case "Q":
                  for (var v = t, d = i, h = 1; h < n; h++)
                    (!(function (e, t, r, n, a, i, o, l) {
                      var f = 1 - o;
                      ((l.x = f * f * e + 2 * f * o * r + o * o * a),
                        (l.y = f * f * t + 2 * f * o * n + o * o * i));
                    })(t, i, f, u, o, l, h / (n - 1), a),
                      r(v, d, a.x, a.y),
                      (v = a.x),
                      (d = a.y));
                                ...
                                e({
                                  ...
                                  setAttribute: function (e, t, n, a, l) {
                                    ...
                                    (f ||
                                      ...
                                      r.bindBuffer(r.ARRAY_BUFFER, f.buf),
                                      ...
                                      r.enableVertexAttribArray(f.loc),
                                      o
                                        ? r.vertexAttribDivisor(f.loc, a)
                                        : v(
                                            "ANGLE_instanced_arrays",
                                          ).vertexAttribDivisorANGLE(f.loc, a),
                                      l !== f.data &&
          ...
          var f = Object.freeze({
            ...
            resizeWebGLCanvasWithoutClearing: function (e, t, r) {
              ...
              o(e, function (i) {
                var o = i.gl,
                  f = new Uint8Array(n * a * 4);
                (o.readPixels(0, 0, n, a, o.RGBA, o.UNSIGNED_BYTE, f),
                  (e.width = t),
                  (e.height = r),
                  l(o, f, 0, 0, n, a));
              });
          ...
          function u(e, t, n, a, i, o) {
            ...
            for (var c = 0; c < e; c++)
              for (var v = 0; v < t; v++) {
                var d = (function (e, t) {
                    for (var r = 1 / 0, n = 1 / 0, a = s.length; a--; ) {
                      var i = s[a];
                      if (i.maxX + n <= e) break;
          ...
          function s(e, t, r, n, a, i, o, l, f, u) {
            (void 0 === i && (i = 1),
              void 0 === l && (l = 0),
              void 0 === f && (f = 0),
              void 0 === u && (u = 0),
              c(e, t, r, n, a, i, o, null, l, f, u));
          }
          function c(e, t, r, n, a, i, o, f, s, c, v) {
            (void 0 === i && (i = 1),
              void 0 === s && (s = 0),
              void 0 === c && (c = 0),
              void 0 === v && (v = 0));
            for (
              var d = u(e, t, r, n, a, i),
                h = new Uint8Array(4 * d.length),
                g = 0;
              g < d.length;
              g++
            )
              h[4 * g + v] = d[g];
            l(o, h, s, c, e, t, 1 << (3 - v), f);
          }
          var v = Object.freeze({
              __proto__: null,
              generate: u,
            ...
            m = new WeakMap();
          function b(e) {
            if (!g && !k(e)) throw Error("WebGL generation not supported");
          }
          function y(e, t, r, n, a, i, l) {
            if (
              ...
              l = h = f.getContext("webgl", { depth: !1 });
            }
            b(l);
            ...
            for (
              var s = new Uint8Array(e * t), c = 0, v = 0;
              c < u.length;
              c += 4
            )
              s[v++] = u[c];
          ...
          function _(e, t, r, n, a, i, o, l, f, u) {
            (void 0 === i && (i = 1),
              void 0 === l && (l = 0),
              void 0 === f && (f = 0),
              void 0 === u && (u = 0),
              w(e, t, r, n, a, i, o, null, l, f, u));
          }
          function w(e, t, a, i, l, f, u, s, c, v, h) {
            (void 0 === f && (f = 1),
              void 0 === c && (c = 0),
              void 0 === v && (v = 0),
              void 0 === h && (h = 0),
                  ...
                  (m("rawDistances", function (r, m) {
                    ((e !== r._lastWidth || t !== r._lastHeight) &&
                      ...
                      p(
                        ...
                        function (n) {
                          var s = n.setAttribute,
                            c = n.setUniform,
                            v = !o && u("ANGLE_instanced_arrays"),
                            h = !o && u("EXT_blend_minmax");
                          (s("aUV", 2, a.STATIC_DRAW, 0, d),
                            s("aLineSegment", 4, a.DYNAMIC_DRAW, 1, g),
                            c.apply(void 0, ["4f", "uGlyphBounds"].concat(i)),
                            c("1f", "uMaxDistance", l),
                            c("1f", "uExponent", f),
                            b(r, m, function (r) {
                              (a.enable(a.BLEND),
          ...
          return (
            ...
            (e.generateIntoCanvas = function (e, t, r, n, a, i, o, l, f, u) {
              (void 0 === a && (a = Math.max(n[2] - n[0], n[3] - n[1]) / 2),
                void 0 === i && (i = 1),
                void 0 === l && (l = 0),
                void 0 === f && (f = 0),
